...
ActiveRecord::Schema.define(version: 2019_04_15_200045) do
  ...
  create_table "bibliographies", id: :serial, force: :cascade do |t|
    t.string "title"
    t.integer "department_id"
    t.text "description"
  end

  create_table "conversation_views", id: :serial, force: :cascade do |t|
    t.integer "conversation_id"
    t.integer "member_id"
    t.datetime "viewed_at"
    t.index ["conversation_id"], name: "index_conversation_views_on_conversation_id"
    t.index ["member_id"], name: "index_conversation_views_on_member_id"
  end
  ...
  create_table "documents", id: :serial, force: :cascade do |t|
    ...
    t.index ["bibliography_id"], name: "index_documents_on_bibliography_id"
  ...
  create_table "fee_payments", id: :serial, force: :cascade do |t|
  ...
  create_table "members", id: :serial, force: :cascade do |t|
    ...
    t.boolean "subscribed_unread_conversations_email", default: false
    t.integer "qualification_cached", default: 0
