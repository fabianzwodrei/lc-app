...
class MembersControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'see qualifications' do
    ...
    assert_select '#qualifications tr:nth-child(1) .title', 'Tim2'
    assert_select '#qualifications tr:nth-child(1) .qualification_validity', "gültig bis #{(Date.yesterday+365).strftime('%d.%m.%Y')}"
  end
